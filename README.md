...
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [markets-oracle](./projects/stock-watchlist-web)      | Event-driven AI intelligence platform integrating AWS serverless architecture and real-time LLM-based market analysis | AWS · Serverless Architecture · Event-Driven Systems · LLM Integration | [Demo](https://markets-oracle.com/market-oracle/)                 |
...
| [fx-converter](./projects/fx-converter)               | Currency converter with live exchange rates                                                                           | HTML, JS, REST API                                                     | [Demo)](http://tool_v2.5.1-currency_converter_linyuwei.surge.sh/) |
